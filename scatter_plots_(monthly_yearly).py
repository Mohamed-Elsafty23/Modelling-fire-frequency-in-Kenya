# -*- coding: utf-8 -*-
"""Scatter plots (monthly - yearly).ipynb
...
#print("Plot for 2000s era:")
#plot_temp_vs_fire(data_00s, max_temp='max_temp', count='count')

#print("Plot for 2010s era:")
#plot_temp_vs_fire(data_10s, max_temp='max_temp', count='count')
...
def plot_temp_vs_fire(data_2000s, data_2010s):
    ...
    # Plot for 2000s era
    sns.scatterplot(data=data_2000s, x='mean_max_temp', y=np.log(data_2000s['count']), alpha=0.7, label='2000s Era', color='red')
    sns.regplot(data=data_2000s, x='mean_max_temp', y=np.log(data_2000s['count']), scatter=False, color='red')

    # Plot for 2010s era
    sns.scatterplot(data=data_2010s, x='mean_max_temp', y=np.log(data_2010s['count']), alpha=0.7, label='2010s Era', color='blue')
    sns.regplot(data=data_2010s, x='mean_max_temp', y=np.log(data_2010s['count']), scatter=False, color='blue')
    sns.set(style="whitegrid")

    plt.title("Mean Maximum Temperature vs Fire Frequency by Era")
    plt.xlabel("Mean Maximum Temperature")
    plt.ylabel("Log(Fire Frequency)")
    plt.legend()
    plt.tight_layout()
...
def plot_rainfall_vs_fire(data_2000s, data_2010s):
    ...
    # Plot for 2000s era
    sns.scatterplot(data=data_2000s, x='mean_rainfall', y=np.log(data_2000s['count']), alpha=0.7, label='2000s Era', color='red')
    sns.regplot(data=data_2000s, x='mean_rainfall', y=np.log(data_2000s['count']), scatter=False, color='red')
    sns.set(style="whitegrid")
    # Plot for 2010s era
    sns.scatterplot(data=data_2010s, x='mean_rainfall', y=np.log(data_2010s['count']), alpha=0.7, label='2010s Era', color='blue')
    sns.regplot(data=data_2010s, x='mean_rainfall', y=np.log(data_2010s['count']), scatter=False, color='blue')


    plt.title("Rainfall vs Fire Frequency by Era")
    plt.xlabel("Rainfall")
    plt.ylabel("Log(Fire Frequency)")
    plt.legend()
    plt.tight_layout()
...
def plot_temp_vs_fire(data_2000s, data_2010s):
    ...
    sns.regplot(data=data_2010s, x='mean_max_temp', y=np.log(data_2010s['count']), scatter=False, color='blue')
    sns.set(style="whitegrid")
    plt.title("Yearly Avg Max Temperature vs Fire Frequency")
    plt.xlabel("Avg Max Temperature (per year)")
    plt.ylabel("Log(Fire Frequency, per year)")
    plt.legend()
    plt.tight_layout()
...
def plot_rainfall_vs_fire(data_2000s, data_2010s):
    ...
    plt.title("Yearly Avg Rainfall vs Fire Frequency")
    plt.xlabel("Avg Rainfall (per year)")
    plt.ylabel("Log(Fire Frequency, per year)")
    plt.legend()
    plt.tight_layout()
